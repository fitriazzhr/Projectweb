    ...
    <header>
        <div class="container">
          <nav>
              ...
              <svg style="color: white" width="74" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M24 42C33.9411 42 42 33.9411 42 24C42 14.0589 33.9411 6 24 6C14.0589 6 6 14.0589 6 24C6 33.9411 14.0589 42 24 42ZM24 44C35.0457 44 44 35.0457 44 24C44 12.9543 35.0457 4 24 4C12.9543 4 4 12.9543 4 24C4 35.0457 12.9543 44 24 44Z" fill="white"></path>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M24 26C27.3137 26 30 23.3137 30 20C30 16.6863 27.3137 14 24 14C20.6863 14 18 16.6863 18 20C18 23.3137 20.6863 26 24 26ZM24 28C28.4183 28 32 24.4183 32 20C32 15.5817 28.4183 12 24 12C19.5817 12 16 15.5817 16 20C16 24.4183 19.5817 28 24 28Z" fill="white"></path>
              </svg>
          </nav>
      </div>
    </header>

          <div id="home" style="background-image: url(images/bgStarrySky.jpg);">
            <div class="row">
          ...
          <div id="contact">
            ...
            <div class="row">
              ...
              <div class="contact-right">
                <form name="myForm" action="submit-form" onsubmit="return validateForm()">
                  <div class="form-contain">
                      <label for="name">Nama</label>
                      <input id="name" type="name" name="name" placeholder="Nama" required>
